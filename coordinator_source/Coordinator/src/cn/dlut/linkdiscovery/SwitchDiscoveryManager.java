 ...
 */
public class SwitchDiscoveryManager implements CoordinatorSendMsg, TimerTask {
    ...
    private CoordinatorLLDP lldpPacket;
    ...
    public SwitchDiscoveryManager(final PhysicalSwitch sw, Boolean... useBDDP) {
        ...
        if (this.useBDDP) {
            ...
            this.bddpEth.setDestinationMACAddress(CoordinatorLLDP.BDDP_MULTICAST);
    ...
    public void handleLLDP(final OFMessage msg, final Switch sw) {
        ...
        if (CoordinatorLLDP.isCoordinatorLLDP(pkt)) {
            final PhysicalPort dstPort = (PhysicalPort) sw.getPort(pi
                    .getInPort());
            final DPIDandPort dp = CoordinatorLLDP.parseLLDP(pkt);

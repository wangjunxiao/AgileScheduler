...
public class PortFeatures {
    ...
    /**
     * Sets the current physical switch port features.
     */
    public void setCurrentPhySwPortFeatures() {
        this.speed10MHD = false;
        this.speed10MFD = false;
        this.speed100MHD = false;
        this.speed100MFD = false;
    ...
    /**
     * Sets the supported physical switch port features.
     */
    public void setSupportedPhySwPortFeatures() {
        this.speed10MHD = true;
        this.speed10MFD = true;
        this.speed100MHD = true;
        this.speed100MFD = true;
    ...
    /**
     * Sets the advertised physical switch port features.
     */
    public void setAdvertisedPhySwPortFeatures() {
        this.speed10MHD = false;
        this.speed10MFD = true;
        this.speed100MHD = false;
        this.speed100MFD = true;
    ...
    /**
     * Sets the peer physical switch port features.
     */
    public void setPeerPhySwPortFeatures() {
        this.speed10MHD = false;
        this.speed10MFD = false;
        this.speed100MHD = false;
        this.speed100MFD = false;
    ...
    /**
     * Gets the physical switch port features.
     *
     * @return the physical switch port features
     */
    public Integer getPhySwFeatures() {
        Integer features = 0;
        if (this.speed10MHD) {
